...
-- Ele cria as tabelas, políticas de segurança, trigger e dados iniciais do sistema.
...
CREATE INDEX IF NOT EXISTS idx_usuario_aluno ON public.usuarios(aluno_id);
...
CREATE INDEX IF NOT EXISTS idx_professor_turma_disciplina_professor ON public.professor_turma_disciplina(professor_id);
